...
void avgPooling(Mat input, Mat &output, int Size) {
...
int main () {
    ...
    Mat pho;
    pho.Init(resolution,resolution,0);
    pho.col=resolution;
    pho.row=resolution;

    freopen("C:\\Users\\64783\\CLionProjects\\untitled\\GUI\\photo.txt","r",stdin);
    freopen("C:\\Users\\64783\\CLionProjects\\untitled\\cmake-build-debug\\ans.txt","w",stdout);
